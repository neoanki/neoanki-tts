...
style.textContent = `:root{color-scheme:light dark;font:16px/1.4 system-ui,sans-serif}*{box-sizing:border-box}body{margin:0;background:transparent;color:#0f172a}.tool{display:flex;align-items:center;gap:8px;padding:2px}.play{width:44px;height:44px;border-radius:10px;border:1px solid #94a3b8;background:#fff;color:#1d4ed8;font:700 18px system-ui;cursor:pointer}.play:focus-visible{outline:3px solid #60a5fa;outline-offset:2px}.play:disabled{opacity:.55}.message{font-size:.82rem;color:#475569;max-width:260px}.disclosure{display:block}:root[data-theme=dark] body{color:#f8fafc}:root[data-theme=dark] .play{background:#1e293b;color:#93c5fd;border-color:#64748b}:root[data-theme=dark] .message{color:#cbd5e1}`
